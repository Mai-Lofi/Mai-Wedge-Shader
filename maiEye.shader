...
Shader "!Mai Lofi!/Eye Wedge Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( _Tint * tex2D( _BaseTexture, ( (( _EyeType2 )?( ( ( (tex2D( _NoiseMap1, ( appendResult10_g33 + appendResult24_g33 ) )).rg * _NoiseMapStrength ) + ( _Vector0 * appendResult58_g33 ) ) ):( float2( 0,0 ) )) + (( _EyeType1 )?( ( ( (tex2D( _Texture2, ( appendResult10_g49 + appendResult24_g49 ) )).rg * _NoiseMapStrength ) + ( _Vector0 * appendResult58_g49 ) ) ):( float2( 0,0 ) )) + (( _EyeType3 )?( ( ( (tex2D( _Texture0, ( appendResult10_g48 + appendResult24_g48 ) )).rg * _NoiseMapStrength ) + ( _Vector0 * appendResult58_g48 ) ) ):( float2( 0,0 ) )) ) ) * _emiss ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18800
402;72;961;634;1002.161;620.6333;1.57006;True;False
...
ASEEND*/
//CHKSM=75A31EE2ABF2553C6E093252EE98ED182EDA9E8E